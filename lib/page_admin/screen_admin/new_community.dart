...
class AddNewCommunoty extends StatefulWidget {
  AddNewCommunoty({Key key}) : super(key: key);

  @override
  _AddNewCommunotyState createState() => _AddNewCommunotyState();
}

class _AddNewCommunotyState extends State<AddNewCommunoty> {
